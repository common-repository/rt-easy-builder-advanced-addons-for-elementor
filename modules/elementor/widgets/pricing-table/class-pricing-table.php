		...
		$fields = array(
			'pricing_table_content_settings' => array(
				...
				'fields' => array(
					...
					'currency' => array(
						'label' => esc_html__( 'Currency', 'rt-easy-builder' ),
						'type'  => 'text',
						'default' => '$'
					),
					'amount' => array(
						'label' => esc_html__( 'Amount', 'rt-easy-builder' ),
						'type'  => 'text',
						'default' => '3'
					),
					'period' => array(
						'label' => esc_html__( 'Period', 'rt-easy-builder' ),
						'type'  => 'text',
						'default' => 'month'
					),
					'button_text' => array(
						'label'   => esc_html__( 'Button Label', 'rt-easy-builder' ),
						'type'    => 'text',
						'default' => 'Select'
					),
					'button_link' => array(
			...
			'pricing_table_features_settings' => array(
				'label' => esc_html__( 'Features', 'rt-easy-builder' ),
				'fields' => array(
					'features' => array(
						'label'   => esc_html__( 'Add', 'rt-easy-builder' ),
						'type'    => 'repeater',
						'title_field' => '{{{ label }}}',
						'fields' => array(
							'label' => array(
	...
	public function get_style_fields(){
		$fields = array(
			...
			'period_style' => array(
				...
				'fields' => array(
					'font-family' => array(
						'label' => esc_html__( 'Font Family', 'rt-easy-builder' ),
						'type' => 'font',
						'default' => '',
						'selectors' => array( 
