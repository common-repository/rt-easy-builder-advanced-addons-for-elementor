	...
	public function get_content_fields(){
		$fields = array(
			'featured_slider_content_settings' => array(
				'label' => esc_html__( 'Slides', 'rt-easy-builder' ),
				'fields' => array(
					'slides' => array(
						'title_field' => '{{{ title }}}',
						'type' => 'repeater',
						'fields' => array(
							...
							'content' => array(
								'label' => esc_html__( 'Content', 'rt-easy-builder' ),
								'type'  => 'textarea',
							...
							'button_text_1' => array(
								'label'   => esc_html__( 'Button Text', 'rt-easy-builder' ),
								'type'    => 'text',
								'default' => 'More'
							),
							'button_link_1' => array(
								'label'   => esc_html__( 'Button Link', 'rt-easy-builder' ),
								'type'    => 'url',
								'default' => array(
									'url' => '#'
								)
			...
			'featured_slider_option' => array(
				'label' => esc_html__( 'Slider Options', 'rt-easy-builder' ),
				'fields' => array(
					'show_dots' => array(
						'label'   => esc_html__( 'Show Dots', 'rt-easy-builder' ),
						'type'    => 'switcher',
						'default' => 'yes'
					),
					'show_arrows' => array(
						'label'   => esc_html__( 'Show Arrows', 'rt-easy-builder' ),
						'type'    => 'switcher',
						'default' => 'yes'
					),
					'infinite' => array(
						'label'   => esc_html__( 'Infinite', 'rt-easy-builder' ),
						'type'    => 'switcher',
						'default' => 'yes'
					),
					'slides_to_show' => array(
						'label'   => esc_html__( 'Slides to show', 'rt-easy-builder' ),
						'type'    => 'number',
						'default' => 1,
						'max'     => 2,
						'min'     => 1
	...
	public function get_style_fields(){
		$fields = array(
			'slide_style' => array(
				...
				'fields' => array(
					'height' => array(
						'label' => esc_html__( 'Height', 'rt-easy-builder' ),
						'type'  => 'slider',
					...
					'width' => array(
						'label' => esc_html__( 'Width', 'rt-easy-builder' ),
						'type'  => 'slider',
					...
					'gap' => array(
						'label' => esc_html__( 'Gap Between Slides', 'rt-easy-builder' ),
						'description' => esc_html__( 'Works only if slides to show is greater than 1.', 'rt-easy-builder' ),
						'type'  => 'slider',
						'size_units' => array( 'px' ),
			...
			'button_style' => array(
				'label'  => esc_html__( 'Button', 'rt-easy-builder' ),
				'fields' => array(
					'typography' => array(
						'label'    => esc_html__( 'Typography', 'rt-easy-builder' ),
						'type'     => 'typography',
					...
					'padding' => array(
						'label'      => __( 'Padding', 'rt-easy-builder' ),
						'type'       => 'dimensions',
						'size_units' => array( 'px' ),
