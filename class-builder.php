...
class Builder{
	...
	public function old_php_admin_error_notice() {
		...
		/* translators: %2$s: opening strong tag  <strong>*/
		/* translators: %3$s: closing strong tag  </strong>*/
		/* translators: %4$s: break tag <br />  */
		$message = sprintf( esc_html__( 'The %2$sRT Easy Builder%3$s plugin requires %2$sPHP 5.3.2+%3$s to run properly. Please contact your hosting company and ask them to update the PHP version of your site to at least PHP 5.3.2.%4$s Your current version of PHP: %2$s%1$s%3$s', 'rt-easy-builder' ), phpversion(), '<strong>', '</strong>', '<br>' );
